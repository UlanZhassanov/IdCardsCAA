...
class Barcode
{
    ...
    protected function _createImage()
    {
        ...
        $this->_image = imagecreate($this->_width, 60);
    ...
    protected function _drawBars()
    {
        ...
        $MAX   = $this->_height*0.01;
        $FLOOR = $this->_height*0.3;//Высота линии
        $WIDTH = $this->scale;

        $x = ($this->_height * 0.07) - $WIDTH;
    ...
    {
        $x = $this->_width*0.05;
        $y = $this->_height*0.45; //высота текста
